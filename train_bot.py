...
#lemmatize, lower eack word and remove duplicates
...
for doc in documents:
    ...
    pattern_words = doc[0]
    #lemmatizeeach word -create base word, in attempt to represent
    pattern_words = [lemmatizer.lemmatize(word.lower()) for word in pattern_words]
    #create our bag of words aarat with l, if word match found in current pattern
    for w in words:
